...
function rubik_preprocess_form_node(&$vars) {
  ...
  // Move Partner Reference to the sidebar
  if(isset($vars['form']['field_partner_reference'])){
    $vars['sidebar']['field_partner_reference'] = $vars['form']['field_partner_reference'];
    unset($vars['form']['field_partner_reference']);
  }
}
